...
<p align="center">
  <a href="https://devtools.at/tools/date-calculator"><img src="https://img.shields.io/badge/Try%20Online-DevTools.at-blue?style=for-the-badge" alt="Try Online"></a>
...
<p align="center">
  <b>Calculate differences between dates</b>
</p>

<p align="center">
  <a href="https://devtools.at/tools/date-calculator">Try Online</a> •
...
**[Try Date Calculator online at DevTools.at →](https://devtools.at/tools/date-calculator)**
...
Calculate differences between dates. This is a standalone TypeScript/JavaScript implementation that you can use in your own projects.
...
```typescript
import { process } from '@devtools-at/date-calculator';
